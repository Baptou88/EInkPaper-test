...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=*/ 2, /*DC=*/ 13, /*RST=*/ 14, /*BUSY=*/ 36)); //Heltec Wifi Lora V2 test1
#endif
